	...
	<nav class="navbar navbar-transparent navbar-absolute">
    	<div class="container">
        	...
        	<div class="collapse navbar-collapse" id="navigation-example">
				...
				<li><button onclick="window.location='register_form.php'" class="btn btn-round btn-login">Register</button></li>
				<li><button onclick="window.location='signin_form.php'" class="btn btn-round btn-login">Sign in</button></li>
        		</ul>
        	</div>
    	</div>
    </nav>
	<div class="image-container set-full-height" style="background-image: url('../assets/img/bg/guest.jpg')">
		            ...
		            <div class="wizard-container">
		                ...
		                <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
		                    	...
		                    	<div class="wizard-header">
									...
									<h5>Let's start with the basic information</h5>
		                    	</div>
