...
<head>
    ...
    <title>Update Personality - Type</title>
...
$sql = "SELECT * FROM personality_type WHERE persontypeID='$persontypeID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="mapupdate_persontype.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="persontypeID" value="<?php echo $persontypeID; ?>" disabled='disabled' />
											<input type="hidden" name="persontypeID" value="<?php echo $persontypeID; ?>" />
                                        </div>

										<div class="form-group">
                                            <label>Personality Name</label>
                                            <input class="form-control" name="personName" type="text" id="personName" value="<?=$personName;?>" size="30" placeholder="Personality Name" required="required" />
