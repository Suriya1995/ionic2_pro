                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<form role="form" action="add_emotion.php" method="post">
                                        <div class="form-group">
                                            <label>Name</label>
											<input class="form-control" name="emoName" type="text" id="emoName" size="35" required="required" placeholder="Please Insert Emotion Name">
                                        </div>
