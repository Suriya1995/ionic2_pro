...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">All Tables</h1>
                </div>
            </div>
...
$result = mysqli_query($conn,$query);
                                ...
                                echo    "<tr>";
                                        echo "<td>" .$row["emoID"]. "</td>";
										echo "<td>" .$row["emoName"]. "</td>";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
...
$query = "SELECT * FROM emotion_personality ORDER BY emoperID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr>";
                                        echo "<td>" .$row["emoperID"]. "</td>";
										echo "<td>" .$row["emoName"]. "</td>";
										echo "<td>" .$row["personName"]. "</td>";
										echo "</tr>";
								}
...
$query = "SELECT * FROM emotion_type ORDER BY emotypeID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr>";
                                        echo "<td>" .$row["emotypeID"]. "</td>";
										echo "<td>" .$row["emoName"]. "</td>";
										echo "<td>" .$row["typeName"]. "</td>";
										echo "</tr>";
								}
...
$query = "SELECT * FROM personality_type ORDER BY persontypeID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr>";
                                        echo "<td>" .$row["persontypeID"]. "</td>";
										echo "<td>" .$row["personName"]. "</td>";
										echo "<td>" .$row["typeName"]. "</td>";
										echo "</tr>";
								}
