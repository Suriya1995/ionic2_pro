...
$query = "SELECT * FROM place_type ORDER BY placetype_ID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr align='center'>";
                                        echo "<td>" .$row["placetype_ID"]. "</td>";
										echo "<td>" .$row["placetype_Name"]. "</td>";
                                        echo "<td>" .$row["fk_place_Name"]. "</td>";
                                        

										echo "<td><a href='mapedit_placetype.php?placetype_ID=$row[0]'>Edit</a></td>";

										echo "<td><a href='deletemap_placetype.php?placetype_ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
