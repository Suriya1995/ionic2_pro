                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<form role="form" action="add_type.php" method="post">
                                        <div class="form-group">
                                            <label>Name</label>
											<input class="form-control" name="typeName" type="text" id="typeName" size="35" required="required" placeholder="Please Insert Type Name">
                                        </div>
