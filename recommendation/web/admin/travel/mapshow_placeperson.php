                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Tables of Place - Personality
                        </div>
                        <!-- /.panel-heading -->
...
$query = "SELECT * FROM place_personality ORDER BY placeperson_ID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr align='center'>";
                                        echo "<td>" .$row["placeperson_ID"]. "</td>";
                                        echo "<td>" .$row["placepersontype_Name"]. "</td>";
										echo "<td>" .$row["placeperson_Name"]. "</td>";
                                       
										echo "<td><a href='mapedit_placeperson.php?placeperson_ID=$row[0]'>Edit</a></td>";

										echo "<td><a href='deletemap_placeperson.php?placeperson_ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
