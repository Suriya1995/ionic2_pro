...
<head>
    ...
    <title>Update Emotion - Personality</title>
...
$sql = "SELECT * FROM emotion_personality WHERE emoperID='$emoperID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="mapupdate_emoperson.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="emoperID" value="<?php echo $emoperID; ?>" disabled='disabled' />
											<input type="hidden" name="emoperID" value="<?php echo $emoperID; ?>" />
                                        </div>
                                        ...
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='mapshow_emoperson.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
