...
$result = mysqli_query($conn,$query);
                                ...
                                echo    "<tr align='center'>";
										...
										echo "<td><a href='edit_emotion.php?emoID=$row[0]'>Edit</a></td>";

										echo "<td><a href='delete_emotion.php?emoID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
