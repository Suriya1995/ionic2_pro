...
$query = "SELECT * FROM place_emotion ORDER BY placeemo_ID asc" or die("Error:" .mysqli_error());
$result = mysqli_query($conn,$query);

                                echo "<tbody>";
								while($row = mysqli_fetch_array($result)){
                                echo    "<tr align='center'>";
                                        echo "<td>" .$row["placeemo_ID"]. "</td>";
                                        echo "<td>" .$row["placeemotype_Name"]. "</td>";
										echo "<td>" .$row["placeemo_Name"]. "</td>";
										

										echo "<td><a href='mapedit_placeemo.php?placeemo_ID=$row[0]'>Edit</a></td>";

										echo "<td><a href='deletemap_placeemo.php?placeemo_ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
