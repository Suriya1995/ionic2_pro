            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Mapping Data<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
$sql = "SELECT * FROM emotions WHERE emoID='$emoID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="update_emotion.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="emoID" value="<?php echo $emoID; ?>" disabled='disabled' />
											<input type="hidden" name="emoID" value="<?php echo $emoID; ?>" />
                                        </div>
                                        ...
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='showform_emotion.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
