...
<head>
    ...
    <title>Update Personality</title>
...
$sql = "SELECT * FROM personality WHERE personID='$personID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="update_personality.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="personID" value="<?php echo $personID; ?>" disabled='disabled' />
                                        ...
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='showform_personality.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
