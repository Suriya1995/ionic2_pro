...
<head>
    ...
    <title>Update Place - Personality</title>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="mapshow_placeemo.php">Place - Emotion</a>
                                </li>
                                <li>
                                    <a href="mapshow_placeperson.php">Place - Personality</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
$sql = "SELECT * FROM place_personality WHERE placeperson_ID='$placeperson_ID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="mapupdate_placeperson.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="placeperson_ID" value="<?php echo $placeperson_ID; ?>" disabled='disabled' />
											<input type="hidden" name="placeperson_ID" value="<?php echo $placeperson_ID; ?>" />
                                        </div>

										<div class="form-group">
                                            <label>Place Personality Name</label>
                                            <input class="form-control" name="placeperson_Name" type="text" id="placeperson_Name" value="<?=$placeperson_Name;?>" size="30" placeholder="Place Personality Name" required="required" />
											<!-- <input type="hidden" name="emoID" value="123"> -->
                                        </div>
                                        
										<div class="form-group">
                                            <label>Place PersonalityType Name</label>
                                            <input class="form-control" name="placepersontype_Name" type="text" id="placepersontype_Name" value="<?=$placepersontype_Name;?>" size="30" placeholder="Place Personality Type Name" required="required" />
                                        </div>

                                        <input type="submit" class="btn btn-default" name="update" id="update" value="Update">
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='mapshow_placeperson.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
