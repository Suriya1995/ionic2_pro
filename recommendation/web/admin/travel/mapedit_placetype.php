...
$sql = "SELECT * FROM place_type WHERE placetype_ID='$placetype_ID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="mapupdate_placetype.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="placetype_ID" value="<?php echo $placetype_ID; ?>" disabled='disabled' />
											<input type="hidden" name="placetype_ID" value="<?php echo $placetype_ID; ?>" />
                                        </div>

										<div class="form-group">
                                            <label>Personality Name</label>
                                            <input class="form-control" name="fk_place_Name" type="text" id="fk_place_Name" value="<?=$fk_place_Name;?>" size="30" placeholder="Place Name" required="required" />
											<!-- <input type="hidden" name="emoID" value="123"> -->
                                        </div>
                                        
										<div class="form-group">
                                            <label>Type Name</label>
                                            <input class="form-control" name="placetype_Name" type="text" id="typeName" value="<?=$placetype_Name;?>" size="30" placeholder="Type Name" required="required" />
                                        </div>
