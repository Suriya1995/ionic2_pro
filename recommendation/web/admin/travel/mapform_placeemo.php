                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="map_placeemo.php" method="post">
                                        <div class="form-group">
                                            <label>Selects Place</label>
                                            <select class="form-control" name="type">
												<option value="">-- Please Select Item--</option>
											<?php 
												include('connect_db.php');

												$query = "SELECT * FROM place ORDER BY place_ID asc" or die("Error:" .mysqli_error());
												$result = mysqli_query($conn,$query);
												while($objResult = mysqli_fetch_array($result))
												{
												?>
												<option value="<?php echo $objResult["place_name"];?>"><?php echo $objResult["place_name"];?></option>
												<?php
												}
												?>
											</select>
										...
										<div class="form-group">
											...
											<select class="form-control" name="emoName">
												<option value="">-- Please Select Item--</option>
											<?php 
												include('connect_db.php');
