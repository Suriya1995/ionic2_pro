...
<head>
    ...
    <title>Emotion - Personality</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Tables of Emotion - Personality
                        </div>
                        <!-- /.panel-heading -->
...
$result = mysqli_query($conn,$query);
                                ...
                                echo    "<tr align='center'>";
										...
										echo "<td><a href='mapedit_emoperson.php?emoperID=$row[0]'>Edit</a></td>";

										echo "<td><a href='deletemap_emoperson.php?emoperID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
