                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="fregist" method="post" action="save_register.php">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" name="conpassword" id="conpassword" type="password" required>
                                        </div>
                                        ...
                                        <input type="submit" class="btn btn-default" name="add" id="add" value="Register">
