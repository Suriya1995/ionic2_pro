...
extract($row);
?>
									<form role="form" action="update_type.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="typeID" value="<?php echo $typeID; ?>" disabled='disabled' />
                                        ...
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='showform_type.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
