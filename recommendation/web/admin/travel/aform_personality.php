                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<form role="form" action="add_personality.php" method="post">
                                        <div class="form-group">
                                            <label>Name</label>
											<input class="form-control" name="personName" type="text" id="personName" size="35" required="required" placeholder="Please Insert Personality Name">
                                        </div>
