                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Tables of Personality - Type
                        </div>
                        <!-- /.panel-heading -->
...
$result = mysqli_query($conn,$query);
                                ...
                                echo    "<tr align='center'>";
										...
										echo "<td><a href='mapedit_persontype.php?persontypeID=$row[0]'>Edit</a></td>";

										echo "<td><a href='deletemap_persontype.php?persontypeID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">Delete</a></td> ";
										echo "</tr>";
								}
                                echo "</tbody>";
								?>
