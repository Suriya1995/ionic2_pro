...
<head>
    ...
    <title>Update Emotion - Type</title>
...
$sql = "SELECT * FROM emotion_type WHERE emotypeID='$emotypeID'";
$result = mysqli_query($conn,$sql) or die ("Error in query: $sql " . mysqli_error());
$row = mysqli_fetch_array($result);
extract($row);
?>
									<form role="form" action="mapupdate_emotype.php" method="post">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input class="form-control" name="emotypeID" value="<?php echo $emotypeID; ?>" disabled='disabled' />
											<input type="hidden" name="emotypeID" value="<?php echo $emotypeID; ?>" />
                                        </div>

										<div class="form-group">
                                            <label>Emotion Name</label>
                                            <input class="form-control" name="emoName" type="text" id="emoName" value="<?=$emoName;?>" size="30" placeholder="Emotion Name" required="required" />
											<!-- <input type="hidden" name="emoID" value="123"> -->
                                        </div>
                                        
										<div class="form-group">
                                            <label>Type Name</label>
                                            <input class="form-control" name="typeName" type="text" id="typeName" value="<?=$typeName;?>" size="30" placeholder="Type Name" required="required" />
                                        </div>

                                        <input type="submit" class="btn btn-default" name="update" id="update" value="Update">
                                        <input type="button" class="btn btn-default" name="button" id="button" value="Cancel" onclick="window.location='mapshow_emotype.php'"  />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
